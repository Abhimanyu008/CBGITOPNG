...
public class IPngConverter {
  ...
  private File getTargetFile(File convertedFile) throws IOException {
    ...
    //    Path relativeConvertedPath = source.toPath().relativize(convertedFile.toPath());
        String relativeConvertedPath = source.toURI().relativize(convertedFile.toURI()).getPath();
  ...
  public static void main(String[] args) throws Exception {
    ...
    log.addHandler(sh);
  //  new IPngConverter(new File("/home/abhimanyu/Desktop/AppIcon76x76~ipad.png"), new File("/home/abhimanyu/Desktop/AppIcon76x76~ipadnew.png")).convert();
